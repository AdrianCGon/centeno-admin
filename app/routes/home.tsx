      ...
      <nav className="navbar navbar-expand-lg" style={{backgroundColor: '#FD8200'}}>
        <div className="container-fluid">
          ...
          <div className="navbar-nav ms-auto">
            ...
            <a className="nav-link text-white" href="/comparar-excel">
        ...
        <div className="row">
          ...
          <div className="col-md-4 mb-4">
            <div className="card border-0 shadow-sm">
              ...
              <div className="card-body">
                <p className="card-text">Carga y compara archivos Excel para encontrar coincidencias por nombre de comisión.</p>
                <a href="/comparar-excel" className="btn" style={{backgroundColor: '#FD8200', color: 'white'}}>
                  <i className="fas fa-arrow-right me-1"></i>
                  Comparar Archivos Excel
                </a>
              </div>
